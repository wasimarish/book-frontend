...
// import { createAOrder } from '../../../../backend/src/orders/order.controller';

// const CheckoutPage = () => {
//   const cartItems = useSelector(state => state.cart.cartItems);
//   const totalPrice = cartItems.reduce((acc, item) => acc + item.newPrice, 0).toFixed(2);
//   const totalItems = cartItems.length;
//   // const currentUser = { email: 'user@example.com' }; // Dummy data for currentUser
...
//                         className="px-4 appearance-none outline-none text-gray-800 w-full bg-transparent h-10 border mt-1 rounded bg-gray-50"
//                         placeholder="Country"
//                       />
